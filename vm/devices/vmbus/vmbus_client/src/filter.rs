...
pub struct ClientFilterBuilder<'a> {
    clients: Vec<&'a mut ClientFilterBuilderX>,
}
...
pub struct ClientFilterBuilderX {
    name: String,
    interfaces: Vec<Guid>,
...
pub fn filter_client(name: impl Into<String>) -> ClientFilterBuilderX {
    ClientFilterBuilderX {
        name: name.into(),
        interfaces: Vec::new(),
        instances: Vec::new(),
        rest: false,
...
impl<'a> ClientFilterBuilder<'a> {
    ...
    pub fn add_client(&mut self, client: &'a mut ClientFilterBuilderX) -> &mut Self {
